...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class ActoresControllerTest : BasePruebas
    {
        ...
        public async Task ObtenerPersonasPaginadas()
        {
            ...
            contexto.Actores.Add(new Entities.Actor() { Nombre = "Actor 1" });
            contexto.Actores.Add(new Entities.Actor() { Nombre = "Actor 2" });
            contexto.Actores.Add(new Entities.Actor() { Nombre = "Actor 3" });
            ...
            var pagina1 = await controller.Get(new DTOs.PaginacionDTO() { Pagina = 1, CantidadRegistroPorPagina = 2 });
            ...
            var pagina2 = await controller.Get(new DTOs.PaginacionDTO() { Pagina = 2, CantidadRegistroPorPagina = 2 });
            ...
            var pagina3 = await controller.Get(new DTOs.PaginacionDTO() { Pagina = 3, CantidadRegistroPorPagina = 2 });
        ...
        public async Task CrearActorSinImagen()
        {
            ...
            var actor = new ActorCreacionDTO() { Nombre = "Ricardo", FechaNacimiento = DateTime.Now };
        ...
        [TestMethod]
        public async Task PatchActualizarSoloCampo()
        {
            var nombreBD = Guid.NewGuid().ToString();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
            ...
            var actor = new Actor() { Nombre = "Ricardo", FechaNacimiento = fechaNacimiento };
            ...
            objectValidator.Setup(x => x.Validate(It.IsAny<ActionContext>(),
                It.IsAny<ValidationStateDictionary>(),It.IsAny<string>(),
                It.IsAny<object>()
                ));
