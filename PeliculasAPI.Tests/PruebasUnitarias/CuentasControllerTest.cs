...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class CuentasControllerTest: BasePruebas
    {
        ...
        private CuentasController ConstruirCuentasController(string nombreBD)
        {
            ...
            var allUserStore = new UserStore<IdentityUser>(context);
            var userManager = BuildUserManager(allUserStore);
            ...
            {
                { "jwt:key","kwqeoi2j3iei3j1k231ijdowsmk1n2i3121ujsndankdn1iu2hj812u3ij12i3njud123hjbfjwndjwnhe1h23b1jqnoajsnajn12wdew59we9qj212u1" }
            };

            var configuracion = new ConfigurationBuilder().AddInMemoryCollection(miConfiguracion)
                .Build();

            return new CuentasController(userManager, signInManager, configuracion, context, mapper);
        }
