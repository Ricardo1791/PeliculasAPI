...
namespace PeliculasAPI
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        {
            var rolAdminId = "6dff0c0d-09c0-43f9-84de-d76af8b6fdd7";
            var usuarioAdminId = "25b44f01-ff80-4aed-ad83-3c7b290cda93";
            ...
            var username = "ric.alv1791@gmail.com";
            ...
            modelBuilder.Entity<SalaDeCine>()
               .HasData(new List<SalaDeCine>
               {
                    ...
                    //new SalaDeCine{Id = 2, Nombre = "Cinemark San Miguel", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-77.088628, -12.076616))},
                    //new SalaDeCine{Id = 3, Nombre = "Cineplanet San Miguel", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-77.083678, -12.075751))},
                    //new SalaDeCine{Id = 4, Nombre = "Cineplanet Larcomar", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-77.031000, -12.131549))}
